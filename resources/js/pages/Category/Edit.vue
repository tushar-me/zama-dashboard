...
const items = ref([
    { label: 'Edit Catergory' }
]);
const form = useForm({
    _method: 'PUT',
    name: props.category.name ?? '',
    order_level: props.category.order_level ?? 0,
    image: null,
    type: props.category.type,
    print_type: props.category.print_type,
    status: props.category.status,
    title: props.category.title,
    us_charge: props.category.shipping_charge.us_charge ?? 0,
    us_add_charge_per_item: props.category.shipping_charge.us_add_charge_per_item ?? 0,
    worldwide_charge: props.category.shipping_charge.worldwide_charge ?? 0,
    worldwide_add_charge_per_item:  props.category.shipping_charge.worldwide_add_charge_per_item ?? 0,
})

const onSubmit = () => {
    form.post(`/category/${props.category.id}`, {
        forceFormData: true,
        onSuccess: () => {
    ...
    <div class="border border-gray-200 rounded-2xl overflow-hidden bg-white">
        ...
        <form @submit.prevent="onSubmit" class="p-4">
            ...
            <div class="flex items-center gap-4 mb-2">
                ...
                <div>
                    <UFileUpload v-model="form.image" :initialImage="category.image" />
