...
class CampaignAttachArtworkDefaultRemainingColorsJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        foreach($products as $product){
            foreach($product->productSides as $side){
                ...
                $colors = ProductColor::query()->where('product_id', $product->id)->where('is_default', false)->get();
